    ...
    <section class="privacyTerms" style="padding-top:6rem">
      <div class="container">
        <div class="row">
          ...
          <p class="justify">You must be a resident of the United States (including its territorial possessions) and at least eighteen (18) years of age to access and use the Site.</p>
          
          <p class="justify">THESE TERMS CONTAIN AN AGREEMENT TO ARBITRATE ALL CLAIMS, A WAIVER OF YOUR ABILITY TO BRING OR PARTICIPATE IN ANY CLASS ACTION LAWSUIT OR CLASS-WIDE ARBITRATION AND
           ALSO CONTAINS DISCLAIMERS OF WARRANTIES AND LIABILITY (please see Sections 9, 10, 11 and 13). These provisions form an essential basis of our bargain. If you do not
            agree to these Terms, you are not authorized to access or use the Site or the Services offered on the Site and you should stop using and exit the Site.</p>
          <br />
          <p class="justify"><b>1. Our Services.</b> 
            Company is not an installer of solar systems nor an Installer of products related to solar systems or products. 
             Nor is Company an agent, representative, or broker thereof of any Installer.This Site does not constitute an offer 
              for installation of solar products. Company is merely a free referral service through which interested consumers can 
               connect with a prospective network of independent, third party installers and installer networks.
  
              Our Site acts as a venue to allow Solar dealers, companies and other third party installation companies find the best opportunities available in 
          ...
          <p class="justify">The data and other information you may provide IMG is not, and is not treated as, an application for a pre-approved, pre-qualified or any similar concept. IMG does not guarantee acceptance into 
            ...
            terms or rates offered and made available by Providers are the best terms or lowest rates available in the market. A Provider's offer may be subject to market conditions, approval and qualification (including possibly a 
             credit check). The rates and fees actually provided by Providers may be higher or lower depending on your complete profile and other considerations used by the Providers. Unless expressly stated in writing, nothing 
              contained herein shall constitute an offer or promise for a commitment or guaranteed agreement. Providers may not offer all products featured on the Site. You might not be matched with the Provider making any specific offer. 
               To help the government fight identity theft, the funding of terrorism and money laundering activities, and to help attempt to verify your identity, Providers may obtain, verify and record information that identifies each person 
                who applied for or obtain insurance from them. For example, they may ask for your name, Social Security Number or driver's license number, address, date of birth, and other important information, that will allow proper identification 
           ...
           <p class="justify">By submitting information your request form or similar form on our Site, you authorize us to provide such information to Providers in order to help you complete your request 
            (including providing you with information about other products or services in which you have expressed an interest). Additionally, where applicable, you authorize the Providers 
            to verify the accuracy and authenticity of all information supplied by you, both internally and with the assistance of unaffiliated third parties or credit bureaus.</p>

              <br />
              
              <p class="justify"><b>2. Personal Use.</b> Although we do charge a fee to Providers to purchase Leads or information we gather from our Sites, and we may from time to time charge users fees for utilizing various other services that 
               may now or in the future be provided by our Site, we do not charge users to access the public portions of our Site. Accordingly, we grant each user a limited, revocable, non-exclusive license to access the Site in order to, as applicable, 
                view or make legitimate inquiries to us regarding our Service, all in accordance with these Terms. We further grant each Provider a limited, revocable, non-exclusive license to access the password-protected portions of the Site or the Service 
                 (as applicable) in accordance with these Terms or any written agreement between us and the Provider. Any other use of the Site or the Service is expressly prohibited. Importantly, this limited license does not include any right of collection, 
                  aggregation, copying, duplication, display or modification of the Site or the Service nor any right of use of data mining, robots, spiders or similar data gathering and extraction tools without our prior written permission; provided, however, 
                   that a limited exception from the foregoing exclusion is provided to general purpose internet search engines and non-commercial public archives that use tools to gather information for the sole purpose of displaying hyperlinks to the Site, 
                    provided that they each do so from a stable IP address or range of IP addresses using an easily identifiable agent and comply with our robots.txt file.</p>
                    
                  <br />
                  <p class="justify"><b>3. Proprietary Rights and Downloading of Information from the Site.</b> The Site is protected by copyright as a collective work and/or compilation, pursuant to U.S. copyright laws, international conventions, and other copyright laws. The text, files, images, photos, maps and other materials 
                  ...
                  <p class="justify"><b>4. Unauthorized Use.</b> Unless otherwise provided within these Terms, or unless otherwise applicable law requires us to allow you to do so, you may not do any of the
                   following without our prior written consent:</p>
                  <ul>
            <li style="list-style-type:disc;">Copy reproduce, upload, post, display, republish, distribute, or transmit any part of the Content in any form whatsoever;</li> 
            <li style="list-style-type:disc;">Reproduce any portion of the Site or the Service on your website or otherwise, using any device including, but not limited to, use of a frame or border
             environment or other framing technique, to enclose any portion or aspect of the Site or Service, or mirror or replicate any portion of the Site or Service;</li>
            <li style="list-style-type:disc;">Modify, translate into any language or computer language, or create derivative works from, any Content or any part of this Site or Service;</li>
            <li style="list-style-type:disc;">Reverse engineer any part of this Site or the Service;</li>
            <li style="list-style-type:disc;">Sell, offer for sale, transfer, or license any portion of the Site or Service in any form to any third parties;</li>
            <li style="list-style-type:disc;">Use any robot, spider, other automatic device, or manual process to monitor, copy, or keep a database copy of the Content or any portion of the Site or Service;</li>
            <li style="list-style-type:disc;">Use the Site other than to learn about our Service and to make legitimate inquiries to us regarding our Service;</li>
            <li style="list-style-type:disc;">Use the Site to create any false or fraudulent account or inquiry or engage in any fraudulent action;</li>
            <li style="list-style-type:disc;">Post or transmit any unlawful, threatening, abusive, libelous, defamatory, obscene, vulgar, indecent, inflammatory, sexually explicit,
             pornographic or profane material or any material that could constitute or encourage conduct that would be considered 
             a criminal offense, give rise to civil liability, or otherwise violate any law or for any other purpose that is unlawful or prohibited by these Terms;</li>
            <li style="list-style-type:disc;">Post or transmit any information that constitutes or contains false or misleading indications of origin or statements of fact;</li>
            <li style="list-style-type:disc;">Use or access the Site in any way that, in our sole discretion, adversely affects the performance or function of the Site or any other
             computer systems or networks used by us or the Site, or infringes on our copyright or any copyright of our Providers;</li>
            <li style="list-style-type:disc;">Violate, plagiarize or infringe the rights of third parties including, without limitation, copyright, trademark or patent rights, rights
             of publicity or privacy or any other proprietary rights;</li>
            <li style="list-style-type:disc;">Upload or transmit to the Site or use in connection with the Site any device, software or routine that contains viruses, Trojan horses, worms,
             time bombs, or other computer programming routines that may damage, interfere or attempt to interfere with, or in any way disrupt or intercept the 
             normal operation of the Site, or appropriate the Site or any system, or take any action that imposes an unreasonable load on our computer equipment,
              systems or networks; or</li>
            <li style="list-style-type:disc;">Disguise the origin of any information or inquiry transmitted through the Site.</li>
          </ul>
          <p class="justify">If we believe that you are engaging in any activity through or in connection with the Site or the Service that appears to be in violation of the above, or
             in violation of any other provision of these Terms or a violation of applicable law or regulations, we may, without limiting our other rights and remedies,
              immediately terminate any further use of the Site or Service by you without notice.</p>
          <br />
            
          <p class="justify"><b>5. Changes to Site.</b> We may change, remove, suspend or discontinue any aspect of the Site at any time, including the availability of any Site features, database, or Content,
          ...
          <br />
          <p class="justify"><b>7. Data Transmittal.</b> Each user acknowledges and agrees that, regardless of such user's physical location, we may store and process any
           data transmitted to the Site from such user at locations both within and outside of the United States.  By using the Site, you consent to the
            transfer of your information to the United States and agree that any transactions you conduct through the Site will be deemed to have occurred in the
             United States.  </p>
          <br />
              ...
              <p class="justify"><b>9. Limitation of Liability.</b> IN NO EVENT WILL IMG, OUR AFFILIATES, OFFICERS, MEMBERS, MANAGERS, DIRECTORS, AGENTS AND/OR EMPLOYEES (COLLECTIVELY,
               THE "IMG GROUP") BE LIABLE FOR ANY LOST PROFITS OR DATA OR ANY INDIRECT, CONSEQUENTIAL, SPECIAL, INCIDENTAL, OR PUNITIVE DAMAGES ARISING OUT OF, BASED
                ...
                <p class="justify"><b>10. Disclaimer.</b> THE SITES AND THE SERVICE, INCLUDING ALL CONTENT, SOFTWARE, FUNCTIONS, SERVICES, MATERIALS AND INFORMATION MADE AVAILABLE ON OR
                 ACCESSED THROUGH THE SITES OR THE SERVICE, ARE PROVIDED "AS IS." TO THE FULLEST EXTENT PERMISSIBLE BY LAW, WE MAKE NO REPRESENTATIONS OR WARRANTIES OF ANY KIND WHATSOEVER 
                 FOR THE CONTENT ON THE SITE OR THE SERVICES, MATERIALS, INFORMATION AND FUNCTIONS MADE ACCESSIBLE BY THE SOFTWARE USED ON OR ACCESSED THROUGH THE SITES OR THE SERVICE, FOR ANY 
                 PRODUCTS OR SERVICES OR HYPERTEXT LINKS TO THIRD PARTIES, OR FOR ANY BREACH OF SECURITY ASSOCIATED WITH THE TRANSMISSION OF SENSITIVE INFORMATION THROUGH THE SITES OR ANY LINKED
                  SITE. FURTHER, WE EXPRESSLY DISCLAIM ALL EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, NON-INFRINGEMENT, MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, COMPLETENESS 
                  AND ACCURACY. WE DO NOT WARRANT THAT THE FUNCTIONS CONTAINED IN THE SITES OR ANY SERVICES, MATERIALS OR CONTENT CONTAINED THEREIN WILL BE UNINTERRUPTED OR ERROR FREE, THAT DEFECTS WILL
                   BE CORRECTED, OR THAT THE SITES OR THE SERVER THAT MAKES IT AVAILABLE IS FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.  SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF IMPLIED WARRANTIES,
                ...
                PLEASE READ CAREFULLY. THE FOLLOWING AFFECTS YOUR RIGHTS</b></p>
              <ol type="A">
          ...
          Attn:  Legal Dept.<br />
          <br />
          or, when we need to send you notice, to any email address you may provide to the Site during the registration process or when submitting an
           inquiry (as applicable). Notice shall be deemed given upon receipt or 24 hours after email is sent, unless the sending party is notified that
            the email address is invalid. Alternatively, we may give you notice by certified mail, postage prepaid and return receipt requested or by national 
            courier service, to any address provided to us during the registration process or when submitting an inquiry (as applicable). 
          </p>
          <br />
          <p class="justify"><b>16. Amendments.</b> We reserve the right, in our sole discretion, to change, modify, add or remove any portion of these Terms, in whole
           or in part, at any time. Notification of changes to these Terms will be posted on the Sites and will be effective immediately thereafter. Your submission
            of a quote request and/or other use of the Sites following the posting of any such change, modification or amendment to these Terms will constitute your 
            acceptance thereof.  When we post changes to these Terms, we will revise the "last updated" date at the top of these Terms. Accordingly, you should periodically
               ...
               or the law; and (vi) a statement that the information in the notification is accurate, and under penalty of perjury, that you are authorized
                ...
                <p class="justify"><b>18. Links to Third-Party Sites.</b> This Site may contain links and pointers to other Internet sites that are not owned or controlled by IMG. IMG has no
                 control over, and assumes no responsibility for the products, services, content, privacy policies or practices of any third-party website or application. Links to and
                  ...
                  <p class="justify"><b>19. Your Record of These Terms.</b> We do not separately file the Terms entered into by each user of the Site. Please make a copy of these Terms for your records by
                   printing and/or saving a downloaded copy of the Terms on your personal computer.
                </p>
                <br />
                <p class="justify"><b>20. Miscellaneous.</b> We may immediately and in our sole discretion terminate any user's access to or use of the Site due to such user's breach of these Terms or
                 our Privacy Policy, or other unauthorized use of the Site. Any claim or cause of action you may have hereunder or with respect to your use of the Sites or the
                  Service must be commenced within one (1) year after the claim or cause of action first arises. Our failure to exercise or enforce any right or provision of these
                   Terms shall not constitute a waiver of any such right or provision. If for any reason a court of competent jurisdiction or an arbitrator finds any provision of
                    these Terms, or portion thereof, to be unenforceable, that provision shall be enforced to the maximum extent permissible so as to effect the intent of these Terms,
